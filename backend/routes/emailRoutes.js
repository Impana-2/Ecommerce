...
//     const mailOptions = {
//       from: `"Chiguru Cloth Store" <${process.env.EMAIL_USER}>`,
//       to: email,// Recipients
//       subject: "🎁 Thanks for Subscribing to Chiguru!",
...
router.post("/sendemail", async (req, res) => {
  ...
  try {
    ...
    await transporter.sendMail(mailOptions);
    console.log(`Subscription email sent successfully`);
    return res.status(200).json({ success: true, message: "Subscribed successfully. Check Email for Coupon" });
