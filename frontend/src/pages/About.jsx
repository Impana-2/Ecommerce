    ...
    <div className="about-page">
      ...
      <div className="about-section">
        ...
        <div className="about-content">
          <p>
            👔 Welcome to Chiguru, your ultimate destination for stylish apparel. We are dedicated to bringing you the best in fashion and quality. Our e-commerce platform is meticulously designed to provide a seamless shopping experience, ensuring you find the perfect pieces to elevate your wardrobe.
          </p>
          <p>
            👗 At Chiguru, we believe in the power of fashion to express individuality and confidence. Our curated collections feature a wide range of clothing that combines contemporary trends with timeless elegance. Whether you're looking for casual wear, formal attire, or something in between, we have something for everyone.
          </p>
